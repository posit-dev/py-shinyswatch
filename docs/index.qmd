...
> Note: When writing [shiny apps that use shinyswatch on shinylive.io](`{python} shiylive_example_url("darkly")`), remember to add `shinyswatch` to your `requirements.txt` file!
